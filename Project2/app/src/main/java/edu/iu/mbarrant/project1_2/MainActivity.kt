...
class MainActivity : AppCompatActivity() {
    override fun onConfigurationChanged(newConfig: Configuration) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            setContentView(R.layout.activity_main_land) // Load the landscape layout
        } else {
            setContentView(R.layout.activity_main) // Load the portrait layout
        }
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val buttonIds = arrayOf(
            ...
            R.id.buttonEquals, R.id.buttonClear, R.id.buttonPercent, R.id.buttonEquals, R.id.buttonTimes, R.id.buttonSin,
            R.id.buttonCos, R.id.buttonTan, R.id.buttonLog, R.id.buttonLn
        )
